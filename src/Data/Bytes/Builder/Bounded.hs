...
int32BE (I32# i) = word32BE (W32# (wordToWord32# (int2Word# (int32ToInt# i))))

int16BE :: Int16 -> Builder 2
int16BE (I16# i) = word16BE (W16# (wordToWord16# (int2Word# (int16ToInt# i))))

int64LE :: Int64 -> Builder 8
int64LE (I64# i) = word64LE (W64# (int2Word# i))

int32LE :: Int32 -> Builder 4
int32LE (I32# i) = word32LE (W32# (wordToWord32# (int2Word# (int32ToInt# i))))

int16LE :: Int16 -> Builder 2
int16LE (I16# i) = word16LE (W16# (wordToWord16# (int2Word# (int16ToInt# i))))
